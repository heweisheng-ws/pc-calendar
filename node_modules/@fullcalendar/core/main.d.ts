...
declare module '@fullcalendar/core' {
    ...
    export { DateMarker, addDays, startOfDay, addMs, holiaDay,addWeeks, diffWeeks, diffWholeWeeks, diffWholeDays, diffDayAndTime, diffDays, isValidDate } from '@fullcalendar/core/datelib/marker';
