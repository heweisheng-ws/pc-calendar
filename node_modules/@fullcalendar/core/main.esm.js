    ...
    if (!rangeContainsMarker(dateProfile.activeRange, date)) {
        ...
        if (options.monthMode &&
            dateEnv.getMonth(date) !== dateEnv.getMonth(dateProfile.currentRange.start)) {
                ...
                if(dateEnv.getMonth(date) < dateEnv.getMonth(dateProfile.currentRange.start)){
                    classes.push('fc-last-month')
                }
                else if(dateEnv.getMonth(date) > dateEnv.getMonth(dateProfile.currentRange.start)){
...
var FillRenderer = /** @class */ (function () {
    ...
    FillRenderer.prototype.renderSegHtml = function (type, seg) {
        ...
        if (type === 'businessHours') {
            ...
            classNames.push('fc-sss' + type.toLowerCase());
